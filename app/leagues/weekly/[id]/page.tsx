...
export default function LeagueDetailsPage() {
  ...
  console.log(league?.startDate, 'start date details page')
        ...
        >
          <div className="md:w-2/3">
            ...
            {league.status === "upcoming" && (
              ...
              >
                {/* Remove or comment out the old countdown */}
                ...
                {/* New countdowns using the Countdown component */}
                ...
                {/* Remove or comment out the old gameweek deadline countdown */}
                {/* {gameweekInfo && (
                  <div className="bg-gradient-to-br from-gray-800/80 to-gray-900/80 border border-gray-700 p-5 rounded-lg backdrop-blur-sm">
                    <h2 className="text-lg font-semibold mb-3 flex items-center">
